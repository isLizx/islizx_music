...
import cn.islizx.music.service.impl.SongListServiceImpl;
...
public class SongListController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/songListPic/**").addResourceLocations("file:F:\\musicfile\\img\\songListPic\\");
        }
    }*/
...
//    更新歌单图片
    ...
    public Object updateSongListPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        String storeAvatorPath = "musicfile/img/songListPic/"+fileName;
        try {
            ...
            SongList songList = new SongList();
            songList.setId(id);
            songList.setPic(URLPREFIX + "/" + storeAvatorPath);
