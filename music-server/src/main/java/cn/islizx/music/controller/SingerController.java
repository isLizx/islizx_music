...
import cn.islizx.music.service.impl.SingerServiceImpl;
...
public class SingerController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/singerPic/**").addResourceLocations("file:F:\\musicfile\\img\\singerPic\\");
        }
    }*/
...
//    更新歌手头像
    ...
    public Object updateSingerPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        String storeAvatorPath = "musicfile/img/singerPic/"+fileName;
        try {
            ...
            Singer singer = new Singer();
            singer.setId(id);
            singer.setPic(URLPREFIX + "/" + storeAvatorPath);
            boolean res = singerService.updateSingerPic(singer);
            if (res){
                jsonObject.put("code", 1);
                jsonObject.put("pic", URLPREFIX + "/" + storeAvatorPath);
